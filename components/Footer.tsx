const Footer = ({}) => {
  return (
    <footer className="row-start-3 flex gap-[24px] flex-wrap text-center px-6">
      <p className="text-white">
        ...
        Ltd. or any of its subsidiaries. All Splatoon™ and Nintendo® trademarks
        and images are the property of Nintendo.
      </p>
    </footer>
  );
};
